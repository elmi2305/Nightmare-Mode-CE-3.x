...
public class EntityDungCreeper extends EntityCreeper implements EntityWithCustomPacket {
    ...
    public Packet getSpawnPacketForThisEntity() {
        ...
        try {
            EntityDungCreeper par1EntityLivingBase = this;
            dataStream.writeInt(21);

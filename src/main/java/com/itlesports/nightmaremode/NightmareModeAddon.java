...
public class NightmareModeAddon extends BTWAddon implements ModInitializer {
    ...
    private static void addPacketManagementForCustomEntities() {
        ...
        CustomEntityPacketHandler.entryMap.put(PACKET_CREEPER_VOID, (world, dataStream, packet) -> {
            EntityVoidCreeper entityToSpawn = new EntityVoidCreeper(world);
            Packet24MobSpawn mobSpawnPacket = new Packet24MobSpawn();
            mobSpawnPacket.readPacketData(dataStream);
            double var2 = (double) mobSpawnPacket.xPosition / 32.0;
            double var4 = (double) mobSpawnPacket.yPosition / 32.0;
        ...
        CustomEntityPacketHandler.entryMap.put(PACKET_CREEPER_GLITCH, (world, dataStream, packet) -> {
            EntityGlitchCreeper entityToSpawn = new EntityGlitchCreeper(world);
            Packet24MobSpawn mobSpawnPacket = new Packet24MobSpawn();
            mobSpawnPacket.readPacketData(dataStream);
            double var2 = (double) mobSpawnPacket.xPosition / 32.0;
            double var4 = (double) mobSpawnPacket.yPosition / 32.0;
        ...
        CustomEntityPacketHandler.entryMap.put(PACKET_RIFT, (world, dataStream, packet) -> {
            EntityRift entityToSpawn = new EntityRift(world);
            Packet24MobSpawn mobSpawnPacket = new Packet24MobSpawn();
            mobSpawnPacket.readPacketData(dataStream);
            double var2 = (double) mobSpawnPacket.xPosition / 32.0;
            double var4 = (double) mobSpawnPacket.yPosition / 32.0;

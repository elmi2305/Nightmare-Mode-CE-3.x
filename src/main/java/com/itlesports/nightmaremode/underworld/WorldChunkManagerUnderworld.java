...
public class WorldChunkManagerUnderworld extends WorldChunkManager {
    ...
    protected WorldChunkManagerUnderworld() {
        this.biomeCache = new BiomeCache(this);
    }
    public WorldChunkManagerUnderworld(long par1, WorldType par3WorldType) {
        this();
        GenLayer[] var4 = UnderworldGenLayer.initializeAllBiomeGenerators(par1, par3WorldType);
        this.genBiomes = var4[0];
        this.biomeIndexLayer = var4[1];
    }

    public WorldChunkManagerUnderworld(World par1World) {
        this(par1World.getSeed(), par1World.getWorldInfo().getTerrainType());
        this.difficulty = par1World.worldInfo.getDifficulty();
    }

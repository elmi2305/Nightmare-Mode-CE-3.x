...
public abstract class HammerRecipeList {
    public static void addRecipes() {
        ...
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.crackedDiamondBearingRock), new ItemStack(NMItems.diamondBearingRock)).setHitsRequired(16);
        ...
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.carbonIronPlate), new ItemStack(NMItems.carbonIronIngot)).setHitsRequired(10);
        ...
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.tungstenPlate), new ItemStack(NMItems.tungstenIngot)).setHitsRequired(4);
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.quartzglassPlate), new ItemStack(NMItems.quartzglassIngot)).setHitsRequired(12);
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.crackedEmerald), new ItemStack(Item.emerald)).setHitsRequired(6);
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.verdantPlate), new ItemStack(NMItems.verdantIngot)).setHitsRequired(5);
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.blackglassPlate), new ItemStack(NMItems.blackglassIngot)).setHitsRequired(10);
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.coresteelPlate), new ItemStack(NMItems.coresteelIngot)).setHitsRequired(20);
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.deadzoneAlloyPlate), new ItemStack(NMItems.deadzoneAlloyIngot)).setHitsRequired(24);
        ...
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.azureCeramicPlate), new ItemStack(NMItems.azureCeramicIngot)).setHitsRequired(3);
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.prismaticPlate), new ItemStack(NMItems.prismaticIngot)).setHitsRequired(12);
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.phaseSteelPlate), new ItemStack(NMItems.phaseSteelIngot)).setHitsRequired(8);
        ...
        HammerCraftingManager.instance.addRecipe(new ItemStack(NMItems.carbonIronNugget, 2), NMBlocks.carburizedIronBloom,
        ...
        HammerCraftingManager.instance.addItemRecipe(new ItemStack(NMItems.tungstenPowder), new ItemStack(NMItems.brittleTungstenCake)).setHitsRequired(4);

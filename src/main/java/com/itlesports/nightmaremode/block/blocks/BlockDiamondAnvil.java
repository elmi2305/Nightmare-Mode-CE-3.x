...
public class BlockDiamondAnvil extends NMBlockContainer {
    ...
    public BlockDiamondAnvil(int id) {
        ...
        this.setUnlocalizedName("ifhyDiamondAnvil");
        this.setTextureName("nightmare:ifhyDiamondAnvil");
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
        ...
        if (!(tile instanceof TileEntityDiamondAnvil)) {
            tile = new TileEntityDiamondAnvil();

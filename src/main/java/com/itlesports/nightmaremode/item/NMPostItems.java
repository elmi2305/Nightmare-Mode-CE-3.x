...
public class NMPostItems {
    ...
    static {
        ...
        washedIronMix = new NMItem(2608).setTextureName("nightmare:ifhyWashedIronMix").setUnlocalizedName("ifhyWashedIronMix").setCreativeTab(CreativeTabs.tabMaterials);
        stompedCrushedIronStoneMix = new NMPlaceAsBlockItem(2609, NMBlocks.blockCrushedIronLayer.blockID).setTextureName("nightmare:ifhyDriedCrushedIron").setUnlocalizedName("ifhyDriedCrushedIron").setCreativeTab(CreativeTabs.tabMaterials);

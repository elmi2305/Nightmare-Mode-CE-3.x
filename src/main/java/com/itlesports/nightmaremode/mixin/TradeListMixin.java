...
public class TradeListMixin {
    ...
    private static void customFarmerTrades(CallbackInfo ci){
        ...
        TradeProvider.getBuilder().profession(0).level(1).convert().input(TradeItem.fromID(Block.tallGrass.blockID,10,20)).secondInput(TradeItem.fromID(Item.emerald.itemID,1,3)).output(TradeItem.fromID(BTWItems.hempSeeds.itemID,2,6));

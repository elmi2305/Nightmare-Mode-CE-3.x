...
public class ComponentOceanDesertTemple extends ComponentScatteredFeature {
    ...
    public ComponentOceanDesertTemple() {
    }

    public ComponentOceanDesertTemple(Random random, int x, int z) {
        super(random, x, 45, z, 21, 15, 21);
    }
    ...
    public boolean addComponentParts(World world, Random generatorRand, StructureBoundingBox boundingBox) {
        ...
        int sandstoneBlockID = NMBlocks.prismarine.blockID;
        int stairBlockId = NMBlocks.prismarineStairs.blockID;
        int stoneSingleSlabID = Block.stoneSingleSlab.blockID;
        int obsidianID = Block.obsidian.blockID;
        int pressurePlate = Block.pressurePlatePlanks.blockID;

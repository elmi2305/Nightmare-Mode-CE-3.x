...
public abstract class OldNMInitializer implements AchievementExt {
...
//        removeParent(BTWAchievements.CRAFT_PLANTER, SPIN_POTTERY);
    ...
    public static void editExistingTrades(){
        // farmer
        TradeTweaks.setInputCount("btw:buy_loose_dirt", 48, 64);
        TradeTweaks.setInputCount("btw:buy_logs", 32,48);
        TradeTweaks.setInputCount("btw:buy_logs_variant_oak", 48, 64);
        TradeTweaks.setInputCount("btw:buy_logs_variant_spruce", 48, 64);
        TradeTweaks.setInputCount("btw:buy_logs_variant_birch", 48, 64);
        TradeTweaks.setInputCount("btw:buy_logs_variant_jungle", 48, 64);
        TradeTweaks.setInputCount("btw:buy_brown_wool", 48, 64);
        TradeTweaks.setOutputCount("btw:buy_brown_wool", 1,1);
        TradeTweaks.setInputCount("btw:buy_bone_meal", 48, 64);
        TradeTweaks.setOutputCount("btw:buy_iron_hoe", 1,1);
        TradeTweaks.setInputCount("btw:buy_sugar", 48, 64);
        TradeTweaks.setInputCount("btw:buy_cocoa_beans", 12, 16);
        TradeTweaks.setInputCount("btw:buy_brown_mushrooms", 14, 16);
//  TradeTweaks.dropTrade("btw:buy_brown_mushrooms");
        TradeTweaks.setInputCount("btw:buy_hemp_seeds", 48, 64);
        TradeTweaks.setInputCount("btw:buy_eggs", 12, 16);
        TradeTweaks.setInputCount("btw:buy_glass_panes", 32, 48);
        TradeTweaks.setInputCount("btw:buy_milk_bucket", 1,1);
        TradeTweaks.setOutputCount("btw:sell_wheat", 4,8);

        TradeTweaks.setInputCount("btw:sell_apple", 12,16);
        TradeTweaks.setInputCount("btw:buy_millstone", 48,64);
        TradeTweaks.setInputCount("btw:sell_sugar_cane_roots", 8,10);
        TradeTweaks.setOutputCount("btw:sell_sugar_cane_roots", 1,1);
        TradeTweaks.setInputCount("btw:buy_melons", 12, 16);
        TradeTweaks.setInputCount("btw:buy_pumpkins", 12, 16);
        TradeTweaks.setInputCount("btw:buy_chocolate", 12,16);
        TradeTweaks.setOutputCount("btw:buy_shears", 1,1);
        TradeTweaks.setInputCount("btw:buy_flint_and_steel", 1,1);
        TradeTweaks.setOutputCount("btw:buy_flint_and_steel", 1,1);
        TradeTweaks.setInputCount("btw:buy_soap", 48,64);
        TradeTweaks.setInputCount("btw:sell_bread", 8,10);
        TradeTweaks.setInputCount("btw:sell_egg_foods", 8,10);
        TradeTweaks.setInputCount("btw:buy_water_wheel", 1,1);
        TradeTweaks.setInputCount("btw:buy_cement_bucket", 1,1);
        TradeTweaks.setInputCount("btw:buy_light_block", 48, 64);
        TradeTweaks.setInputCount("btw:buy_stump_remover", 12, 16);
        TradeTweaks.setInputCount("btw:sell_desserts", 8,10);
        TradeTweaks.setInputCount("btw:buy_stake_and_string", 48,64);
        TradeTweaks.setInputCount("btw:buy_planters", 48,64);
        TradeTweaks.setInputCount("btw:sell_mycelium", 8,10);
        TradeTweaks.setInputCount("btw:sell_looting_scroll", 48,64);

        // librarian
        TradeTweaks.setInputCount("btw:buy_paper", 48, 64);
        TradeTweaks.setInputCount("btw:buy_ink", 48, 64);
        TradeTweaks.setInputCount("btw:buy_feathers", 48, 6);
        TradeTweaks.setInputCount("btw:buy_book_and_quill", 1,1);
        TradeTweaks.setInputCount("btw:buy_ancient_manuscript", 1,1);
        TradeTweaks.setInputCount("btw:buy_redstone", 48,64);
        TradeTweaks.setInputCount("btw:buy_redstone_latch", 48, 64);
        TradeTweaks.setInputCount("btw:buy_piston", 48,64);
        TradeTweaks.setInputCount("btw:buy_turntable", 48,64);
        TradeTweaks.setOutputCount("btw:buy_brewing_stand", 1,1);
        TradeTweaks.setInputCount("btw:sell_advanced_redstone", 8,10);
        TradeTweaks.setInputCount("btw:buy_nether_wart", 48, 64);
        TradeTweaks.setInputCount("btw:buy_glowstone", 48, 64);
        TradeTweaks.setInputCount("btw:buy_nitre", 48, 64);
        TradeTweaks.setInputCount("btw:buy_spider_eyes", 12, 16);
        TradeTweaks.setInputCount("btw:sell_bookshelf", 8,10);
        TradeTweaks.setInputCount("btw:buy_witch_warts", 48, 64);
        TradeTweaks.setInputCount("btw:buy_mysterious_glands", 48, 64);
        TradeTweaks.setInputCount("btw:buy_fermented_spider_eyes", 48, 64);
        TradeTweaks.setInputCount("btw:buy_ghast_tears", 48, 64);
        TradeTweaks.setInputCount("btw:buy_magma_cream", 48, 64);
        TradeTweaks.setInputCount("btw:buy_blaze_powder", 48, 64);
        TradeTweaks.setInputCount("btw:buy_ender_spectacles", 1,1);
        TradeTweaks.setInputCount("btw:buy_brimstone", 48, 64);
        TradeTweaks.setInputCount("btw:buy_blood_wood_saplings", 48, 64);
        TradeTweaks.setInputCount("btw:buy_nether_groth_spores", 48,64);
//  TradeTweaks.setInputCount("btw:convert_eyes_of_ender", 0,0);
        TradeTweaks.setInputCount("btw:sell_power_scroll", 48,64);

        // priest
        TradeTweaks.setInputCount("btw:buy_hemp", 48, 64);
        TradeTweaks.setInputCount("btw:buy_red_mushrooms", 12, 16);
        TradeTweaks.setInputCount("btw:buy_cactus", 48, 64);
        TradeTweaks.setInputCount("btw:buy_paintings", 48,64);
        TradeTweaks.setInputCount("btw:buy_flint_and_steel", 1,1);
        TradeTweaks.setOutputCount("btw:buy_enchanting_table", 1,1);
        TradeTweaks.setInputCount("btw:enchant_tools", 8,10);
        TradeTweaks.setInputCount("btw:enchant_iron_armor", 8,10);
        TradeTweaks.setInputCount("btw:buy_vessel_of_the_dragon", 48,64);
        TradeTweaks.setInputCount("btw:buy_mob_heads", 48,64);
        TradeTweaks.setInputCount("btw:buy_mob_heads_variant_skeleton", 48, 64);
        TradeTweaks.setInputCount("btw:buy_mob_heads_variant_zombie", 48, 64);
        TradeTweaks.setInputCount("btw:buy_mob_heads_variant_creeper", 48, 64);
        TradeTweaks.setInputCount("btw:buy_bone_block", 48, 64);
        TradeTweaks.setInputCount("btw:buy_rotten_flesh_block", 48, 64);
        TradeTweaks.setInputCount("btw:convert_infused_skull_level_up", 8,10);
        TradeTweaks.setInputCount("btw:buy_candles", 48, 64);
        TradeTweaks.setInputCount("btw:buy_candles_variant_black", 48, 64);
        TradeTweaks.setInputCount("btw:buy_candles_variant_white", 48, 64);
        TradeTweaks.setInputCount("btw:buy_candles_variant_red", 48, 64);
        TradeTweaks.setInputCount("btw:buy_candles_variant_yellow", 48, 64);
        TradeTweaks.setInputCount("btw:buy_candles_variant_blue", 48, 64);
        TradeTweaks.setInputCount("btw:buy_candles_variant_green", 48, 64);
        TradeTweaks.setInputCount("btw:buy_soul_urn", 12, 16);
        TradeTweaks.setInputCount("btw:buy_canvas", 48,64);
        TradeTweaks.setOutputCount("btw:buy_infernal_enchanter", 48,64);
        TradeTweaks.setInputCount("btw:convert_infused_skull", 8,10);
        TradeTweaks.setInputCount("btw:sell_fortune_scroll", 48,64);

        // blacksmith
        TradeTweaks.setInputCount("btw:buy_coal", 48, 64);
        TradeTweaks.setInputCount("btw:buy_birch_logs", 48, 64);
        TradeTweaks.setInputCount("btw:buy_iron_nuggets", 48, 64);
        TradeTweaks.setOutputCount("btw:buy_oven", 48,64);
        TradeTweaks.setOutputCount("btw:buy_anvil_level_up", 48,64);
        TradeTweaks.setInputCount("btw:buy_hibachi", 48, 64);
        TradeTweaks.setOutputCount("btw:buy_hibachi", 1,1);
        TradeTweaks.setInputCount("btw:buy_gold_nuggets", 48, 64);
        TradeTweaks.setInputCount("btw:buy_charcoal", 48, 64);
        TradeTweaks.setInputCount("btw:buy_iron_ingot", 48, 64);
        TradeTweaks.setOutputCount("btw:buy_iron_ingot", 1,1);
        TradeTweaks.setInputCount("btw:sell_iron_equipment", 8,10);
        TradeTweaks.setOutputCount("btw:buy_bellows", 48,64);
        TradeTweaks.setInputCount("btw:buy_nethercoal", 48, 64);
        TradeTweaks.setInputCount("btw:buy_creeper_oysters", 12, 16);
        TradeTweaks.setInputCount("btw:buy_diamonds", 48, 64);
        TradeTweaks.setOutputCount("btw:buy_diamonds", 1,1);
        TradeTweaks.setInputCount("btw:buy_padding", 48, 64);
        TradeTweaks.setInputCount("btw:buy_straps", 48, 64);
        TradeTweaks.setInputCount("btw:sell_chain_armor", 8,10);
        TradeTweaks.setOutputCount("btw:buy_crucible", 1,1);
        TradeTweaks.setInputCount("btw:buy_soul_urns_blacksmith", 12,16);
        TradeTweaks.setInputCount("btw:buy_hafts", 48, 64);
        TradeTweaks.setInputCount("btw:buy_mining_charges", 48, 64);
        TradeTweaks.setInputCount("btw:sell_diamond_equipment", 8,10);
        TradeTweaks.setInputCount("btw:buy_steel_ingots", 48,64);
        TradeTweaks.setOutputCount("btw:buy_steel_ingots", 1,1);
        TradeTweaks.setInputCount("btw:buy_soul_flux", 48, 64);
        TradeTweaks.setInputCount("btw:sell_steel_tools", 8,10);
        TradeTweaks.setInputCount("btw:sell_unbreaking_scroll", 48,64);

        // butcher
        TradeTweaks.setInputCount("btw:buy_arrows", 48, 64);
        TradeTweaks.setOutputCount("btw:buy_shears_butcher", 1,1);
        TradeTweaks.setInputCount("btw:buy_fishing_rod", 1,1);
        TradeTweaks.setOutputCount("btw:buy_bow", 1,1);
        TradeTweaks.setInputCount("btw:sell_meat", 48,64);
        TradeTweaks.setOutputCount("btw:buy_cauldron", 1,1);
        TradeTweaks.setInputCount("btw:buy_flour", 48, 64);
        TradeTweaks.setInputCount("btw:buy_dung", 48, 64);
        TradeTweaks.setInputCount("btw:buy_spruce_bark", 48, 64);
        TradeTweaks.setInputCount("btw:buy_leather", 48, 64);
        TradeTweaks.setInputCount("btw:sell_mid_tier_foods", 8,10);
        TradeTweaks.setOutputCount("btw:buy_saw", 48,64);
        TradeTweaks.setInputCount("btw:buy_potatoes", 48, 64);
        TradeTweaks.setInputCount("btw:buy_carrots", 48, 64);
        TradeTweaks.setInputCount("btw:buy_wolf_chops", 12, 16);
        TradeTweaks.setInputCount("btw:buy_liver", 12,16);
        TradeTweaks.setInputCount("btw:buy_saddle", 1,1);
        TradeTweaks.setInputCount("btw:sell_dinners", 8,10);
        TradeTweaks.setInputCount("btw:sell_tanned_leather", 48,64);
        TradeTweaks.setInputCount("btw:buy_breeding_harness", 48,64);
        TradeTweaks.setInputCount("btw:buy_mystery_meat", 12, 16);
        TradeTweaks.setInputCount("btw:buy_screw", 48,64);
        TradeTweaks.setOutputCount("btw:buy_screw", 1,1);
        TradeTweaks.setInputCount("btw:buy_composite_bow", 1,1);
        TradeTweaks.setInputCount("btw:sell_hearty_stew", 8,10);
        TradeTweaks.setInputCount("btw:sell_tanned_leather_armor", 8,10);
        TradeTweaks.setInputCount("btw:buy_dirty_chopping_block", 48,64);
        TradeTweaks.setInputCount("btw:convert_runed_skull", 8,10);
        TradeTweaks.setInputCount("btw:buy_dynamite", 48,64);
        TradeTweaks.setInputCount("btw:buy_battleaxe", 1,1);
        TradeTweaks.setInputCount("btw:buy_companion_cube", 48,64);
        TradeTweaks.setInputCount("btw:buy_broadhead_arrows", 48, 64);
        TradeTweaks.setInputCount("btw:buy_lightning_rod_and_soap", 48,64);
        TradeTweaks.setInputCount("btw:sell_sharpness_scroll", 8,10);
...
//        RecipeManager.addRecipe(new ItemStack(Block.bookShelf), new Object[]{"###", "XXX", "###", Character.valueOf('#'), new ItemStack(BTWItems.woodSidingStubID, 1, Short.MAX_VALUE), Character.valueOf('X'), new ItemStack(Item.book,1,Short.MAX_VALUE)});
        ...
        RecipeManager.addShapelessRecipe(new ItemStack(NMBlocks.dualInputGearBox),
                new Object[]{BTWBlocks.gearBox, BTWBlocks.axle});
        RecipeManager.addRecipe(new ItemStack(NMItems.mechanicalWrench),
                new Object[]{" I", "G ", Character.valueOf('I'), Item.ingotIron,
